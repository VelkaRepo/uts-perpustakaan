    ...
    <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <a type="button" class="btn btn-primary" href="index.php?page=siswa&aksi=tambah">Tambah Petugas</a>
                    </div>
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="index.php?page=siswa&aksi=edit&id=<?php echo $data['id_petugas'] ?>">Edit</a> | 
                                        <a href="index.php?page=siswa&aksi=hapus&id=<?php echo $data['id_petugas'] ?>">Hapus</a></td>
                                </tr>
                            <?php
                            $no++;
                            }
